	...
	<div id="web_pace_portfolio_options_and_filters_<?php echo esc_attr($portfolioID); ?>">
		...
		<?php if ( $portfolioShowSorting == "on" ) { ?>
			<div id="web_pace_portfolio_options_<?php echo esc_attr($portfolioID); ?>"
			     data-sorting-position="<?php echo esc_attr($photo_gallery_get_options["photo_gallery_ht_view6_sorting_float"]); ?>">
				<ul  class="sort-by-button-group clearfix" >
					<?php if ( $photo_gallery_get_options["photo_gallery_ht_view6_sorting_name_by_default"] != '' ): ?>
						<li><a href="#sortBy=original-order" data-option-value="original-order" class="selected"
						       data><?php echo esc_attr($photo_gallery_get_options["photo_gallery_ht_view6_sorting_name_by_default"]); ?></a></li>
					<?php endif; ?>
					<?php if ( $photo_gallery_get_options["photo_gallery_ht_view6_sorting_name_by_id"] != '' ): ?>
						<li><a href="#sortBy=load_date"
						       data-option-value="load_date"><?php echo esc_attr($photo_gallery_get_options["photo_gallery_ht_view6_sorting_name_by_id"]); ?></a>
						</li>
					<?php endif; ?>
					<?php if ( $photo_gallery_get_options["photo_gallery_ht_view6_sorting_name_by_name"] != '' ): ?>
						<li><a href="#sortBy=name"
						       data-option-value="name"><?php echo esc_attr($photo_gallery_get_options["photo_gallery_ht_view6_sorting_name_by_name"]); ?></a>
						</li>
					<?php endif; ?>
					<?php if ( $photo_gallery_get_options["photo_gallery_ht_view6_sorting_name_by_random"] != '' ): ?>
						<li id="shuffle"><a data-option-value="random"
								href='#shuffle'><?php echo esc_attr($photo_gallery_get_options["photo_gallery_ht_view6_sorting_name_by_random"]); ?></a>
						</li>
					<?php endif; ?>
				</ul>
				<ul id="port-sort-direction" class="option-set clearfix" >
					<?php if ( $photo_gallery_get_options["photo_gallery_ht_view6_sorting_name_by_asc"] != '' ): ?>
						<li><a href="#sortAscending=true" data-option-value="true"  data-option-key="number"
						       class="selected"><?php echo esc_attr($photo_gallery_get_options["photo_gallery_ht_view6_sorting_name_by_asc"]); ?></a>
						</li>
					<?php endif; ?>
					<?php if ( $photo_gallery_get_options["photo_gallery_ht_view6_sorting_name_by_desc"] != '' ): ?>
						<li><a href="#sortAscending=false"  data-option-key="number"
						       data-option-value="false"><?php echo esc_attr($photo_gallery_get_options["photo_gallery_ht_view6_sorting_name_by_desc"]); ?></a>
						</li>
					<?php endif; ?>
				</ul>
			</div>
		...
		if ( $portfolioShowFiltering == "on" ) { ?>
			<div id="web_pace_portfolio_filters_<?php echo esc_attr($portfolioID); ?>"
			     data-filtering-position="<?php echo esc_attr($photo_gallery_get_options["photo_gallery_ht_view6_filtering_float"]); ?>">
				<ul>
					<li rel="*"><a><?php echo esc_attr($photo_gallery_get_options["photo_gallery_ht_view6_cat_all"]); ?></a></li>
					<?php
...
<?php } ?>
	<div id="web_pace_portfolio_container_<?php echo esc_attr($portfolioID); ?>"
	     ...
	     data-show-center="<?php echo esc_attr($portfolioposition); ?>" <?php if ( $photo_gallery_get_options["photo_gallery_ht_view6_sorting_float"] == "top" && $photo_gallery_get_options["photo_gallery_ht_view6_filtering_float"] == "top" ) {
						...
						switch ( photo_gallery_youtube_or_vimeo_portfolio( $imgurl[0] ) ) {
								   ...
								   title="<?php echo esc_attr( $row->name ); ?>">
									<img alt="<?php echo esc_attr( $row->name ); ?>"
									     ...
									     src="<?php echo esc_url( photo_gallery_get_image_by_sizes_and_src( $imgurl[0], array(
										     $photo_gallery_get_options['photo_gallery_ht_view6_width'],
										     ''
									     ), false ) ); ?>"/>
								</a>
								<?php
							...
							case 'youtube':
								...
								<a href="https://www.youtube.com/embed/<?php echo $videourl[0]; ?>"
                                   data-description=" <?php echo esc_attr( $row->description ); ?>"
								   class="web_pace_portfolio_item pyoutube  portfolio-lightbox-group<?php echo esc_attr($portfolioID); ?>"
								   title="<?php echo esc_attr( $row->name ); ?>">
									<img alt="<?php echo esc_attr( $row->name ); ?>"
							...
							case 'vimeo':
								...
								<a class="web_pace_portfolio_item pvimeo  portfolio-lightbox-group<?php echo esc_attr($portfolioID); ?>"
