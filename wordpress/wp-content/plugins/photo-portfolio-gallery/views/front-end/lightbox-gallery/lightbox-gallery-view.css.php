...
.portelement_<?php echo $portfolioID; ?> {
    max-width:<?php echo $photo_gallery_get_options['photo_gallery_ht_view6_width']+2*$photo_gallery_get_options['photo_gallery_ht_view6_border_width']; ?>px;
    width: 100%;
    margin:0 0 10px 0;
    border:<?php echo $photo_gallery_get_options['photo_gallery_ht_view6_border_width']; ?>px solid #<?php echo $photo_gallery_get_options['photo_gallery_ht_view6_border_color']; ?>;
    border-radius:<?php echo $photo_gallery_get_options['photo_gallery_ht_view6_border_radius']; ?>px;
    outline:none;
    overflow:hidden;
}
...
.portelement_<?php echo $portfolioID; ?> .image-block_<?php echo $portfolioID; ?> {
    position:relative;
    max-width:<?php echo $photo_gallery_get_options['photo_gallery_ht_view6_width']; ?>px;
    width:100%;
}
...
.portelement_<?php echo $portfolioID; ?> .image-block_<?php echo $portfolioID; ?> img {
    margin:0 !important;
    padding:0 !important;
    max-width:<?php echo $photo_gallery_get_options['photo_gallery_ht_view6_width']; ?>px !important;
    width: 100%;
    height:auto;
    display:block;
...
.portelement_<?php echo $portfolioID; ?> .title-block_<?php echo $portfolioID; ?> {
    ...
    left:0;
    width:100%;
    height: <?php echo $photo_gallery_get_options["photo_gallery_ht_view6_title_font_size"] + 14; ?>px;
    bottom:-<?php echo $photo_gallery_get_options["photo_gallery_ht_view6_title_font_size"] + 15; ?>px;
    background: <?php
			list($r,$g,$b) = array_map('hexdec',str_split($photo_gallery_get_options['photo_gallery_ht_view6_title_background_color'],2));
				$titleopacity=$photo_gallery_get_options["photo_gallery_ht_view6_title_background_transparency"]/100;
...
.portelement_<?php echo $portfolioID; ?> .title-block_<?php echo $portfolioID; ?> {
    ...
    white-space:nowrap;
    z-index:20;
    font-size: <?php echo $photo_gallery_get_options["photo_gallery_ht_view6_title_font_size"];?>px;
    color:#<?php echo $photo_gallery_get_options["photo_gallery_ht_view6_title_font_color"];?>;
    font-weight:normal;
    border: none;
    box-shadow: none;
}
...
.portelement_<?php echo $portfolioID; ?> .title-block_<?php echo $portfolioID; ?>:hover {
    color:#<?php echo $photo_gallery_get_options["photo_gallery_ht_view6_title_font_hover_color"];?>;
    text-decoration:none;
}
...
#web_pace_portfolio_content_<?php echo $portfolioID; ?> #web_pace_portfolio_options_<?php echo $portfolioID; ?> ul li {
    border-radius: <?php echo $photo_gallery_get_options["photo_gallery_ht_view6_sortbutton_border_radius"];?>px;
...
#web_pace_portfolio_content_<?php echo $portfolioID; ?> #web_pace_portfolio_options_<?php echo $portfolioID; ?> ul li a {
    background-color: #<?php echo $photo_gallery_get_options["photo_gallery_ht_view6_sortbutton_background_color"];?> !important;
    font-size:<?php echo $photo_gallery_get_options["photo_gallery_ht_view6_sortbutton_font_size"];?>px !important;
    color:#<?php echo $photo_gallery_get_options["photo_gallery_ht_view6_sortbutton_font_color"];?> !important;
    text-decoration: none;
    cursor: pointer;
    margin: 0 !important;
    display: block;
    padding:<?php echo $photo_gallery_get_options["photo_gallery_ht_view6_sortbutton_border_padding"];?>px;
    border-radius: <?php echo $photo_gallery_get_options["photo_gallery_ht_view6_sortbutton_border_radius"];?>px;
}


#web_pace_portfolio_content_<?php echo $portfolioID; ?> #web_pace_portfolio_options_<?php echo $portfolioID; ?> ul li a:hover {
    background-color: #<?php echo $photo_gallery_get_options["photo_gallery_ht_view6_sortbutton_hover_background_color"];?> !important;
    color:#<?php echo $photo_gallery_get_options["photo_gallery_ht_view6_sortbutton_hover_font_color"];?> !important;
    cursor: pointer;
}

#web_pace_portfolio_content_<?php echo $portfolioID; ?> #web_pace_portfolio_filters_<?php echo $portfolioID; ?> {
    float: <?php echo $photo_gallery_get_options["photo_gallery_ht_view6_filtering_float"]; ?>;
    position: relative;
<?php   if($filteringFloatLgal != 'top'){
...
#web_pace_portfolio_content_<?php echo $portfolioID; ?> #web_pace_portfolio_filters_<?php echo $portfolioID; ?> ul li a {
    font-size:<?php echo $photo_gallery_get_options["photo_gallery_ht_view6_filterbutton_font_size"];?>px !important;
    color:#<?php echo $photo_gallery_get_options["photo_gallery_ht_view6_filterbutton_font_color"];?> !important;
    background-color: #<?php echo $photo_gallery_get_options["photo_gallery_ht_view6_filterbutton_background_color"];?> !important;
    border-radius: <?php echo $photo_gallery_get_options["photo_gallery_ht_view6_filterbutton_border_radius"];?>px;
    padding:<?php echo $photo_gallery_get_options["photo_gallery_ht_view6_sortbutton_border_padding"];?>px;
    display: block;
    text-decoration: none;
}
...
#web_pace_portfolio_content_<?php echo $portfolioID; ?> #web_pace_portfolio_filters_<?php echo $portfolioID; ?>  ul li a:hover {
    color:#<?php echo $photo_gallery_get_options["photo_gallery_ht_view6_filterbutton_hover_font_color"];?> !important;
    background-color: #<?php echo $photo_gallery_get_options["photo_gallery_ht_view6_filterbutton_hover_background_color"];?> !important;
    cursor: pointer
}
...
#port-sort-direction {
<?php if($photo_gallery_get_options["photo_gallery_ht_view6_sorting_float"] == "top")
...
@media screen and (max-width: <?php echo $photo_gallery_get_options['photo_gallery_ht_view0_block_width']+2*$photo_gallery_get_options['photo_gallery_ht_view6_border_width']+40; ?>px) {
    .portelement_<?php echo $portfolioID; ?>  {
        width:98%;
        margin: 1% !important;
        float: left;
        overflow: hidden;
        outline:none;
        border:<?php echo $photo_gallery_get_options['photo_gallery_ht_view6_border_color']; ?>px solid #<?php echo $photo_gallery_get_options['photo_gallery_ht_view0_element_border_color']; ?>;
    }
