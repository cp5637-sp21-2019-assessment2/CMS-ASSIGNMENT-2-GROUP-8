...
.portelement_<?php echo $portfolioID; ?> {
    background:#<?php echo $photo_gallery_get_options['photo_gallery_ht_view4_element_background_color']?>;
    width:<?php echo $photo_gallery_get_options['photo_gallery_ht_view4_block_width']+2*$photo_gallery_get_options['photo_gallery_ht_view4_element_border_width']; ?>px;
    max-width: calc(100% - 10px);
    height: <?php echo 2*$photo_gallery_get_options['photo_gallery_ht_view4_element_border_width']+45; ?>px;
    margin: 5px;
    float: left;
    overflow: hidden;
    position: relative;
    outline:none;
    border:<?php echo $photo_gallery_get_options['photo_gallery_ht_view4_element_border_width']; ?>px solid #<?php echo $photo_gallery_get_options['photo_gallery_ht_view4_element_border_color']; ?>;
}
...
.title-block_<?php echo $portfolioID; ?> h3 {
    ...
    white-space:nowrap;
    font-weight:normal;
    color:#<?php echo $photo_gallery_get_options['photo_gallery_ht_view4_title_font_color']; ?>;
    font-size:<?php echo $photo_gallery_get_options['photo_gallery_ht_view4_title_font_size']; ?>px;
    line-height: <?php echo $photo_gallery_get_options['photo_gallery_ht_view4_title_font_size'] + 4; ?>px !important;
}
...
.portelement_<?php echo $portfolioID; ?> .title-block_<?php echo $portfolioID; ?> .open-close-button {
    ...
    top:13px;
    right:5px;
    background:url('<?php echo  PHOTO_PORTFOLIO_IMAGES_URL.'/admin_images/open-close.'.$photo_gallery_get_options['photo_gallery_ht_view4_togglebutton_style'].'.png'; ?>') left top no-repeat;
    z-index:5;
    cursor:pointer;
    opacity:0.33;
}
...
.portelement_<?php echo $portfolioID; ?>.large .open-close-button {
    background:url('<?php echo  PHOTO_PORTFOLIO_IMAGES_URL.'/admin_images/open-close.'.$photo_gallery_get_options['photo_gallery_ht_view4_togglebutton_style'].'.png'; ?>') left bottom no-repeat;
}
...
.wd-portfolio-panel_<?php echo $portfolioID; ?> .description-block_<?php echo $portfolioID; ?> p,.portelement_<?php echo $portfolioID; ?> div.right-block .description-block_<?php echo $portfolioID; ?> * {
    text-align:justify;
    font-size:<?php echo $photo_gallery_get_options['photo_gallery_ht_view4_description_font_size']; ?>px;
    color:#<?php echo $photo_gallery_get_options['photo_gallery_ht_view4_description_color']; ?>;
    margin:0px;
    padding:0px;
}
...
.wd-portfolio-panel_<?php echo $portfolioID; ?> > div {
    padding-top:10px;
    margin-bottom:10px;
<?php if($photo_gallery_get_options['photo_gallery_ht_view4_show_separator_lines']=="on") {?>
...
.wd-portfolio-panel_<?php echo $portfolioID; ?> .button-block a, .wd-portfolio-panel_<?php echo $portfolioID; ?> .button-block a:link, .wd-portfolio-panel_<?php echo $portfolioID; ?> .button-block a:visited {
    ...
    font-size:<?php echo $photo_gallery_get_options['photo_gallery_ht_view4_linkbutton_font_size']; ?>px;
    background:#<?php echo $photo_gallery_get_options['photo_gallery_ht_view4_linkbutton_background_color']; ?>;
    color:#<?php echo $photo_gallery_get_options['photo_gallery_ht_view4_linkbutton_color']; ?>;
...
.wd-portfolio-panel_<?php echo $portfolioID; ?> .button-block a:hover, .wd-portfolio-panel_<?php echo $portfolioID; ?> .button-block a:focus, .wd-portfolio-panel_<?php echo $portfolioID; ?> .button-block a:active {
    background:#<?php echo $photo_gallery_get_options['photo_gallery_ht_view4_linkbutton_background_hover_color']; ?>;
    color:#<?php echo $photo_gallery_get_options['photo_gallery_ht_view4_linkbutton_font_hover_color']; ?>;
    text-decoration:none;
}
...
<?php if($photo_gallery_get_options["photo_gallery_ht_view4_sorting_float"] == 'none') { ?>
#web_pace_portfolio_content_<?php echo $portfolioID; ?> #web_pace_portfolio_options_<?php echo $portfolioID; ?> ul {
    float: left;
}
<?php } ?>
...
#web_pace_portfolio_content_<?php echo $portfolioID; ?> #web_pace_portfolio_options_<?php echo $portfolioID; ?> ul li {
    border-radius: <?php echo $photo_gallery_get_options["photo_gallery_ht_view4_sortbutton_border_radius"];?>px;
...
#web_pace_portfolio_content_<?php echo $portfolioID; ?> #web_pace_portfolio_options_<?php echo $portfolioID; ?> ul li a {
    background-color: #<?php echo $photo_gallery_get_options["photo_gallery_ht_view4_sortbutton_background_color"];?> !important;
    font-size:<?php echo $photo_gallery_get_options["photo_gallery_ht_view4_sortbutton_font_size"];?>px !important;
    color:#<?php echo $photo_gallery_get_options["photo_gallery_ht_view4_sortbutton_font_color"];?> !important;
    text-decoration: none;
    cursor: pointer;
    margin: 0px !important;
    display: block;
    border-radius: <?php echo $photo_gallery_get_options["photo_gallery_ht_view4_sortbutton_border_radius"];?>px;
    padding: <?php echo $photo_gallery_get_options["photo_gallery_ht_view4_sortbutton_border_padding"];?>px;
}
...
#web_pace_portfolio_content_<?php echo $portfolioID; ?> #web_pace_portfolio_options_<?php echo $portfolioID; ?> ul li a:hover {
    background-color: #<?php echo $photo_gallery_get_options["photo_gallery_ht_view4_sortbutton_hover_background_color"];?> !important;
    color:#<?php echo $photo_gallery_get_options["photo_gallery_ht_view4_sortbutton_hover_font_color"];?> !important;
    cursor: pointer;
}
...
#web_pace_portfolio_content_<?php echo $portfolioID; ?> #web_pace_portfolio_filters_<?php echo $portfolioID; ?> ul li {
    list-style-type: none;
    border-radius: <?php echo $photo_gallery_get_options["photo_gallery_ht_view4_filterbutton_border_radius"];?>px;
<?php
...
#web_pace_portfolio_content_<?php echo $portfolioID; ?> #web_pace_portfolio_filters_<?php echo $portfolioID; ?> ul li a {
    font-size:<?php echo $photo_gallery_get_options["photo_gallery_ht_view4_filterbutton_font_size"];?>px !important;
    color:#<?php echo $photo_gallery_get_options["photo_gallery_ht_view4_filterbutton_font_color"];?> !important;
    background-color: #<?php echo $photo_gallery_get_options["photo_gallery_ht_view4_filterbutton_background_color"];?> !important;
    border-radius: <?php echo $photo_gallery_get_options["photo_gallery_ht_view4_filterbutton_border_radius"];?>px;
    padding: <?php echo $photo_gallery_get_options["photo_gallery_ht_view4_filterbutton_border_padding"];?>px;
    display: block;
    text-decoration: none;
}

#web_pace_portfolio_content_<?php echo $portfolioID; ?> #web_pace_portfolio_filters_<?php echo $portfolioID; ?>  ul li a:hover {
    color:#<?php echo $photo_gallery_get_options["photo_gallery_ht_view4_filterbutton_hover_font_color"];?> !important;
    background-color: #<?php echo $photo_gallery_get_options["photo_gallery_ht_view4_filterbutton_hover_background_color"];?> !important;
    cursor: pointer
}
...
@media screen and (max-width: <?php echo $photo_gallery_get_options['photo_gallery_ht_view0_block_width']+2*$photo_gallery_get_options['photo_gallery_ht_view4_element_border_width']+40; ?>px) {
    .portelement_<?php echo $portfolioID; ?>  {
        width:98%;
        margin: 1% !important;
        float: left;
        overflow: hidden;
        outline:none;
        border:<?php echo $photo_gallery_get_options['photo_gallery_ht_view4_element_border_width']; ?>px solid #<?php echo $photo_gallery_get_options['photo_gallery_ht_view0_element_border_color']; ?>;
    }
}
