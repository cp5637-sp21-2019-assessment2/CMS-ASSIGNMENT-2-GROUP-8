...
/**
 * Class web_pace_Portfolio_Widget
 */
class Photo_Gallery_Widget extends WP_Widget {

	/**
	 * web_pace_Portfolio_Widget constructor.
	 */
	public function __construct() {
		parent::__construct(
			'Photo_Gallery_Widget',
			'Web Pace Portfolio',
			array( 'description' => __( 'Web Pace Portfolio', 'web_pace_portfolio' ), )
		);
	}
	...
	public function widget( $args, $instance ) {
		if ( isset( $instance['portfolio_id'] ) ) {
			...
			echo do_shortcode( "[web_pace_portfolio id={$portfolio_id}]" );
	...
	public function form( $instance ) {
		...
		<label
			for="<?php echo $this->get_field_id( 'portfolio_id' ); ?>"><?php _e( 'Select portfolio:', 'web_pace_portfolio' ); ?></label>
