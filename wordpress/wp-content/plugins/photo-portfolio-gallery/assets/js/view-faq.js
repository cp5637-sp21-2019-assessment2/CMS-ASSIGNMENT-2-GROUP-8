...
function Photo_Gallery_Faq(id) {
    ...
    _this.defaultBlockWidth = portfolio_param_obj.photo_gallery_ht_view4_block_width;
    ...
    _this.documentReady = function () {
        var options = {
            ...
            masonry: {
                columnWidth: _this.defaultBlockWidth + 15 + portfolio_param_obj.photo_gallery_ht_view4_element_border_width * 2,
            },
            masonryHorizontal: {
                rowHeight: 300 + 15
            },
    ...
    _this.showCenter = function () {
        if (_this.isCentered) {
            ...
            var elementwidth = _this.defaultBlockWidth + 10 + portfolio_param_obj.photo_gallery_ht_view4_element_border_width * 2;
    ...
    _this.dropdownableClick = function () {
        if (jQuery(this).parents('.portelement').hasClass("large")) {
            jQuery(this).parents('.portelement').animate({//
                height: 45 + 2 * portfolio_param_obj.photo_gallery_ht_view4_element_border_width + "px"//pakeluc heto erevacox masi chap@
            }, 700, function () {
        ...
        var strheight = (jQuery(this).parents('.portelement').find('.wd-portfolio-panel').height() + 35 + 2 * portfolio_param_obj.photo_gallery_ht_view4_element_border_width);
...
jQuery(document).ready(function () {
    jQuery(".web_pace_portfolio_container.view-faq").each(function (i) {
        var id = jQuery(this).attr('id');
        portfolios[i] = new Photo_Gallery_Faq(id);
    });
});
