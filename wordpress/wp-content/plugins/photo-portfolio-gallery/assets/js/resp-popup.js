(function ($) {
    ...
    jQuery('.photo-portfolio-content  a').on('click', function(e){
        groupID = jQuery(this).attr('data-groupID');
        jQuery(this).lightboxPortfolio();

    });
    jQuery('.photo-portfolio-content img').on('click', function(e){
        e.preventDefault();
        groupID = jQuery(this).parents('a').attr('data-groupID');
        jQuery(this).lightboxPortfolio();

    });
    jQuery(' .photo-portfolio-content .open-close-button, .photo-portfolio-content .title').on('click', function(){
        groupID = jQuery(this).parent().parent().find('a').attr('data-groupID');
        jQuery(this).lightboxPortfolio();
    });
    jQuery('.photo-portfolio-content .title-block').on('click', function(){
        groupID = jQuery(this).parent().find('a').attr('data-groupID');
        jQuery(this).lightboxPortfolio();
    });
    jQuery(' .photo-portfolio-content .play-icon').on('click', function(){
    ...
    function Lightbox(element, options) {
        ...
        this.$item = '';
        this.$cont = '';
        if(jQuery('.web_pace_portfolio_container').hasClass('view-toggle-up-down') || jQuery('.web_pace_portfolio_container').hasClass('view-full-height') || jQuery('.web_pace_portfolio_container').hasClass('view-full-width') || jQuery('.photo-portfolio-content').hasClass('view-content-slider')) {
    ...
    Lightbox.defaults = {
        ...
        classPrefix: 'rwd-',
        attrPrefix: 'data-',
        slideAnimationType: portfolio_resp_lightbox_obj.photo_gallery_lightbox_slideAnimationType,     /*  effect_1   effect_2    effect_3
         effect_4   effect_5    effect_6
         effect_7   effect_8    effect_9   */
        lightboxView: portfolio_resp_lightbox_obj.photo_gallery_lightbox_lightboxView,              //  view1, view2, view3, view4
        speed: portfolio_resp_lightbox_obj.photo_gallery_lightbox_speed_new,
        width: portfolio_resp_lightbox_obj.photo_gallery_lightbox_width_new+'%',
        height: portfolio_resp_lightbox_obj.photo_gallery_lightbox_height_new+'%',
        videoMaxWidth: portfolio_resp_lightbox_obj.photo_gallery_lightbox_videoMaxWidth,
        sizeFix: true, //not for option
        overlayDuration: +portfolio_resp_lightbox_obj.photo_gallery_lightbox_overlayDuration,
        slideAnimation: true, //not for option
        overlayClose: portfolio_resp_lightbox_obj.photo_gallery_lightbox_overlayClose_new,
        loop: portfolio_resp_lightbox_obj.photo_gallery_lightbox_loop_new,
        escKey: portfolio_resp_lightbox_obj.photo_gallery_lightbox_escKey_new,
        keyPress: portfolio_resp_lightbox_obj.photo_gallery_lightbox_keyPress_new,
        arrows: portfolio_resp_lightbox_obj.photo_gallery_lightbox_arrows,
        mouseWheel: portfolio_resp_lightbox_obj.photo_gallery_lightbox_mouseWheel,
        download: portfolio_resp_lightbox_obj.photo_gallery_lightbox_download,
        showCounter: portfolio_resp_lightbox_obj.photo_gallery_lightbox_showCounter,
        defaultTitle: '',  //some text
        preload: 1,  //not for option
        showAfterLoad: true,  //not for option
        nextHtml: '',  //not for option
        prevHtml: '',  //not for option
        sequence_info: portfolio_resp_lightbox_obj.photo_gallery_lightbox_sequence_info,
        sequenceInfo: portfolio_resp_lightbox_obj.photo_gallery_lightbox_sequenceInfo,
        slideshow: portfolio_resp_lightbox_obj.photo_gallery_lightbox_slideshow_new,
        slideshowAuto: portfolio_resp_lightbox_obj.photo_gallery_lightbox_slideshow_auto_new,
        slideshowSpeed: portfolio_resp_lightbox_obj.photo_gallery_lightbox_slideshow_speed_new,
        slideshowStart: '',  //not for option
        slideshowStop: '',   //not for option
        hideControlOnEnd: false,  //not for option
        watermark: portfolio_resp_lightbox_obj.photo_gallery_lightbox_watermark,
        socialSharing: portfolio_resp_lightbox_obj.photo_gallery_lightbox_socialSharing,
        share: {
            facebookButton: portfolio_resp_lightbox_obj.photo_gallery_lightbox_facebookButton===true,
            twitterButton: portfolio_resp_lightbox_obj.photo_gallery_lightbox_twitterButton===true,
            googleplusButton: portfolio_resp_lightbox_obj.photo_gallery_lightbox_googleplusButton===true,
            pinterestButton: portfolio_resp_lightbox_obj.photo_gallery_lightbox_pinterestButton===true,
            linkedinButton: portfolio_resp_lightbox_obj.photo_gallery_lightbox_linkedinButton===true,
            tumblrButton: portfolio_resp_lightbox_obj.photo_gallery_lightbox_tumblrButton===true,
            redditButton: portfolio_resp_lightbox_obj.photo_gallery_lightbox_redditButton===true,
            bufferButton: portfolio_resp_lightbox_obj.photo_gallery_lightbox_bufferButton===true,
            diggButton: portfolio_resp_lightbox_obj.photo_gallery_lightbox_diggButton===true,
            vkButton: portfolio_resp_lightbox_obj.photo_gallery_lightbox_vkButton===true,
            yummlyButton: portfolio_resp_lightbox_obj.photo_gallery_lightbox_yummlyButton===true
        }
    };
    ...
    Lightbox.prototype.structure = function () {
        ...
        switch($object.settings.lightboxView){
            ...
            case 'view4':
                ...
                break;
            case 'view5':
                var $w = Math.abs(portfolio_resp_lightbox_obj.photo_gallery_lightbox_imageshadowh) + 'px', $l;

                if(portfolio_resp_lightbox_obj.photo_gallery_lightbox_imageshadowh < 0){
                    $l = Math.abs(portfolio_resp_lightbox_obj.photo_gallery_lightbox_imageshadowh);
                ...
                break;
            case 'view6':
                var $w_ = Math.abs(portfolio_resp_lightbox_obj.photo_gallery_lightbox_imageshadowh) + 'px', $l_;

                if(portfolio_resp_lightbox_obj.photo_gallery_lightbox_imageshadowh < 0){
                    $l_ = Math.abs(portfolio_resp_lightbox_obj.photo_gallery_lightbox_imageshadowh);
                    jQuery('.cont-inner').css({
                        width: 'calc(80% - ' + $w_ + ')',
                        left:  $l_ + 'px'
                    });
    ...
    Lightbox.prototype.loadContent = function (index, rec, delay) {
        ...
        if ($object.settings.watermark) {
            ...
            if (isImg()) {
                if(performance.navigation.type === 1 && !jQuery('.web_pace_portfolio_container').hasClass('view-lightbox-gallery') && this.settings.socialSharing){
                    src = $object.$items.eq(index).attr('href');
                } else {
    ...
    Video.defaultsVideo = {
        ...
        classPrefix: 'rwd-',
        attrPrefix: 'data-',
        videoMaxWidth: portfolio_resp_lightbox_obj.photo_gallery_lightbox_videoMaxWidth, //Assigned with line 34
        //videoMaxHeight: '100%',
    ...
    WaterMark.defaults = {
        imgSrc: portfolio_resp_lightbox_obj.photo_gallery_lightbox_watermark_img_src_new,
        text: portfolio_resp_lightbox_obj.photo_gallery_lightbox_watermark_text,
        textColor: '#' + portfolio_resp_lightbox_obj.photo_gallery_lightbox_watermark_textColor,
        textFontSize: +portfolio_resp_lightbox_obj.photo_gallery_lightbox_watermark_textFontSize,
        containerBackground: portfolio_resp_lightbox_obj.photo_gallery_lightbox_watermark_container_bg_color,
        containerWidth: +portfolio_resp_lightbox_obj.photo_gallery_lightbox_watermark_containerWidth,
        position: 'pos'+portfolio_resp_lightbox_obj.photo_gallery_lightbox_watermark_position_new,
        opacity: +portfolio_resp_lightbox_obj.photo_gallery_lightbox_watermark_opacity / 100,
        margin: +portfolio_resp_lightbox_obj.photo_gallery_lightbox_watermark_margin,
    ...
    WaterMark.prototype.imgurltodata = function (data, callback) {
        ...
        img.onload = function () {
            ...
            if (data.$wmObject) {
                ...
                var $opacity = +portfolio_resp_lightbox_obj.photo_gallery_lightbox_watermark_containerOpacity/100;
