...
function Photo_Gallery_Full_Width(id) {
    var _this = this;
    ...
    _this.defaultBlockWidth = portfolio_param_obj.photo_gallery_ht_view3_mainimage_width;
    ...
    _this.documentReady = function () {
        var options = {
            ...
            masonry: {
                columnWidth: _this.defaultBlockWidth + 20 + portfolio_param_obj.photo_gallery_ht_view3_element_border_width * 2,
            },
            masonryHorizontal: {
                rowHeight: 300 + 20
            },
...
jQuery(document).ready(function () {
    jQuery(".web_pace_portfolio_container.view-full-width").each(function (i) {
        var id = jQuery(this).attr('id');
        portfolios[i] = new Photo_Gallery_Full_Width(id);
    });
});