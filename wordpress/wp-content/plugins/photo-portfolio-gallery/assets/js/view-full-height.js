...
function Photo_Gallery_Full_Height(id) {
    var _this = this;
    ...
    _this.defaultBlockHeight = portfolio_param_obj.photo_gallery_ht_view1_block_height;
    _this.defaultBlockWidth = portfolio_param_obj.photo_gallery_ht_view1_block_width;
    ...
    _this.documentReady = function () {
        var options = {
            ...
            masonry: {
                columnWidth: _this.defaultBlockWidth + 15 + portfolio_param_obj.photo_gallery_ht_view1_element_border_width * 2
            },
            masonryHorizontal: {
                rowHeight: 300 + 20
            },
    ...
    _this.showCenter = function () {
        if (_this.isCentered) {
            ...
            var elementwidth = _this.defaultBlockWidth + 15 + portfolio_param_obj.photo_gallery_ht_view1_element_border_width * 2;
...
jQuery(document).ready(function () {
    jQuery(".web_pace_portfolio_container.view-full-height").each(function (i) {
        var id = jQuery(this).attr('id');
        portfolios[i] = new Photo_Gallery_Full_Height(id);
    });
});