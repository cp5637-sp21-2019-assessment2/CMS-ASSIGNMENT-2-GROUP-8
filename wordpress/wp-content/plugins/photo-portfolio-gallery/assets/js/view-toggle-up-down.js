...
function Photo_Gallery_Toggle_Up_Down(id) {
    var _this = this;
    ...
    _this.defaultBlockHeight = portfolio_param_obj.photo_gallery_ht_view0_block_height;
    _this.defaultBlockWidth = portfolio_param_obj.photo_gallery_ht_view0_block_width;
    ...
    _this.documentReady = function () {
        var options = {
            ...
            masonry: {
                columnWidth: _this.defaultBlockWidth + 15 + portfolio_param_obj.photo_gallery_ht_view0_element_border_width * 2,
            },
            masonryHorizontal: {
                rowHeight: 300 + 15
            },
    ...
    _this.manageLoading = function () {
        if (_this.hasLoading) {
            ...
            _this.content.find('div[id^="web-pace-container-loading-overlay_"]').css('display', 'none');
        }
    };
    ...
    _this.showCenter = function () {
        if (_this.isCentered) {
            ...
            var elementwidth = _this.defaultBlockWidth + 15 + portfolio_param_obj.photo_gallery_ht_view0_element_border_width * 2;
    ...
    _this.dropdownableClick = function () {
        ...
        strheight += _this.defaultBlockHeight + 20 + 2 * portfolio_param_obj.photo_gallery_ht_view0_element_border_width + portfolio_param_obj.photo_gallery_ht_view0_title_font_size;
        if (jQuery(this).parents('.portelement').hasClass("large")) {
            jQuery(this).parents('.portelement').animate({
                height: _this.defaultBlockHeight + 20 + 2*portfolio_param_obj.photo_gallery_ht_view0_element_border_width+portfolio_param_obj.photo_gallery_ht_view0_title_font_size
            }, 300, function () {
        ...
        portfolioGalleryIsotope(_this.container,'layout');
        jQuery(this).parents('.portelement').css({height: _this.defaultBlockHeight + 45 + 2 * portfolio_param_obj.photo_gallery_ht_view0_element_border_width + portfolio_param_obj.photo_gallery_ht_view0_title_font_size + "px"});
...
jQuery(document).ready(function () {
    jQuery(".web_pace_portfolio_container.view-toggle-up-down").each(function (i) {
        var id = jQuery(this).attr('id');
        portfolios[i] = new Photo_Gallery_Toggle_Up_Down(id);
    });
});