...
function Photo_Gallery_Lightbox_Glalery(id) {
    var _this = this;
    ...
    _this.defaultBlockWidth = portfolio_param_obj.photo_gallery_ht_view6_width;
    ...
    _this.documentReady = function () {
        var options = {
            ...
            masonry: {
                columnWidth: _this.defaultBlockWidth + 10 + portfolio_param_obj.photo_gallery_ht_view6_border_width * 2,
            },
            masonryHorizontal: {
                rowHeight: 300 + 10
            },
    ...
    _this.showCenter = function () {
        if (_this.isCentered) {
            ...
            var elementwidth = _this.defaultBlockWidth + 10 + portfolio_param_obj.photo_gallery_ht_view6_border_width * 2;
...
jQuery(document).ready(function () {
    jQuery(".web_pace_portfolio_container.view-lightbox-gallery").each(function (i) {
        var id = jQuery(this).attr('id');
        portfolios[i] = new Photo_Gallery_Lightbox_Glalery(id);
    });
});