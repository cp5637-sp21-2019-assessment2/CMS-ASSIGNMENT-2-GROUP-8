jQuery(document).ready(function(){
            ...
            jQuery('#webpaceportfolioinsert').on('click', function () {
                ...
                var id = jQuery('#web_pace_portfolio-select option:selected').val();
                ...
                window.send_to_editor('[web_pace_portfolio id="' + id + '"]');
                tb_remove();
            ...
            jQuery('#web_pace_portfolio-select').change(function () {
