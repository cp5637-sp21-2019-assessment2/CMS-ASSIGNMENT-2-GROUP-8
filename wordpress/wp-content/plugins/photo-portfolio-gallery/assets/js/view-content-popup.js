...
function Photo_Gallery_Content_Popup(id) {
    var _this = this;
    ...
    _this.defaultBlockHeight = portfolio_param_obj.photo_gallery_ht_view2_element_height;
    _this.defaultBlockWidth = portfolio_param_obj.photo_gallery_ht_view2_element_width;
    ...
    _this.documentReady = function () {
        var options = {
            ...
            masonry: {
                columnWidth: _this.defaultBlockWidth + 15 + portfolio_param_obj.photo_gallery_ht_view2_element_border_width * 2,
            },
            masonryHorizontal: {
                rowHeight: 300 + 15
            },
    ...
    _this.showCenter = function () {
        if (_this.isCentered) {
            ...
            var elementwidth = _this.defaultBlockWidth + 15 + portfolio_param_obj.photo_gallery_ht_view2_element_border_width * 2;
    ...
    _this.addEventListeners = function () {
        ...
        _this.body.on('click', '#web-popup-overlay-portfolio', _this.closePopup);
    ...
    _this.overlayClick = function(){
        ...
        jQuery(this).parents('body').append('<div id="web-popup-overlay-portfolio"></div>');
        _this.popupList.insertBefore('#web-popup-overlay-portfolio');
        ...
        jQuery('#web_pace_portfolio_pupup_element_' + strid).addClass('active').css({height: height * 0.7});
        _this.popupList.addClass('active');

        jQuery('#web_pace_portfolio_pupup_element_' + strid + ' ul.thumbs-list li:first-child').addClass('active');
    ...
    _this.leftChange = function(){
        ...
        if (jQuery(this).closest(".pupup-element").prevAll(".pupup-element" + active_rel).length) {
            ...
            jQuery('#web_pace_portfolio_pupup_element_' + strid).css({height: height * 0.7});
    ...
    _this.closePopup = function(){
        ...
        jQuery('#web-popup-overlay-portfolio').remove();
...
jQuery(document).ready(function () {
    jQuery(".web_pace_portfolio_container.view-content-popup").each(function (i) {
        var id = jQuery(this).attr('id');
        portfolios[i] = new Photo_Gallery_Content_Popup(id);
    });
});
