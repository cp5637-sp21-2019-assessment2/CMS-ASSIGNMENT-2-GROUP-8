(function ($) {
    ...
    jQuery('.web_pace_main-image-carousel .main-icon').on('click', function(e){
        jQuery(this).parent().find('a').click().click();
    });
    jQuery('.web_pace_main-carousel-wrapper img').on('click', function(e){
        e.preventDefault();
        jQuery(this).lightboxPortfolioStore();

    });
    jQuery('.web_pace_main-carousel-wrapper a:not(.not_open)').on('click', function(e){
        e.preventDefault();
        jQuery(this).lightboxPortfolioStore();
    ...
    Lightbox.defaults = {
        ...
        classPrefix: 'rwd-',
        attrPrefix: 'data-',
        slideAnimationType: portfolio_store_zoom_obj.photo_gallery_lightbox_slideAnimationType, /*  effect_1   effect_2    effect_3
         effect_4   effect_5    effect_6
         effect_7   effect_8    effect_9   */
        lightboxView: 'view6',              //  view1, view2, view3, view4, view5, view6
        speed: portfolio_store_zoom_obj.photo_gallery_lightbox_speed_new,
        width: portfolio_store_zoom_obj.photo_gallery_lightbox_width_new + '%',
        height: portfolio_store_zoom_obj.photo_gallery_lightbox_height_new + '%',
        videoMaxWidth: portfolio_store_zoom_obj.photo_gallery_lightbox_videoMaxWidth,
        sizeFix: true, //not for option
        overlayDuration: +portfolio_store_zoom_obj.photo_gallery_lightbox_overlayDuration,
        slideAnimation: true, //not for option
        overlayClose: false,
        loop: true,
        escKey: portfolio_store_zoom_obj.photo_gallery_lightbox_escKey_new,
        keyPress: portfolio_store_zoom_obj.photo_gallery_lightbox_keyPress_new,
        arrows:false,
        arrowsHoverEffect:false,
        mouseWheel:false,
        download: false,
        showCounter: portfolio_store_zoom_obj.photo_gallery_lightbox_showCounter,
        showTitle: portfolio_store_zoom_obj.photo_gallery_lightbox_showTitle,
        showDesc: portfolio_store_zoom_obj.photo_gallery_lightbox_showDesc,
        showBorder: portfolio_store_zoom_obj.photo_gallery_lightbox_border,
        borderSize: portfolio_store_zoom_obj.photo_gallery_lightbox_bordersize,
        borderColor: portfolio_store_zoom_obj.photo_gallery_lightbox_bordercolor,
        borderRadius: portfolio_store_zoom_obj.photo_gallery_lightbox_borderradius,
        borderOpacity: portfolio_store_zoom_obj.photo_gallery_lightbox_borderopacity,
        onImageLink: portfolio_store_zoom_obj.photo_gallery_lightbox_enableURL,
        imageLink: portfolio_store_zoom_obj.photo_gallery_lightbox_imageLink,
        imageLinkNewTab: portfolio_store_zoom_obj.photo_gallery_lightbox_linkNewTab,
        defaultTitle: '',  //some text
        preload: 10,  //not for option
        showAfterLoad: true,  //not for option
        nextHtml: '',  //not for option
        prevHtml: '',  //not for option
        sequence_info: portfolio_store_zoom_obj.photo_gallery_lightbox_sequence_info,
        sequenceInfo: portfolio_store_zoom_obj.photo_gallery_lightbox_sequenceInfo,
        slideshow: portfolio_store_zoom_obj.photo_gallery_lightbox_slideshow_new,
        slideshowAuto: portfolio_store_zoom_obj.photo_gallery_lightbox_slideshow_auto_new,
        slideshowSpeed: portfolio_store_zoom_obj.photo_gallery_lightbox_slideshow_speed_new,
        slideshowStart: '',  //not for option
        slideshowStop: '',   //not for option
        hideControlOnEnd: false,  //not for option
        watermark: portfolio_store_zoom_obj.photo_gallery_lightbox_watermark,
        socialSharing: portfolio_store_zoom_obj.photo_gallery_lightbox_socialSharing,
        titlePos: portfolio_store_zoom_obj.photo_gallery_lightbox_title_pos,
        fullwidth: portfolio_store_zoom_obj.photo_gallery_lightbox_fullwidth_effect,
        zoomType: portfolio_store_zoom_obj.photo_gallery_lightbox_zoomtype,
        zoomLogo: portfolio_store_zoom_obj.photo_gallery_lightbox_zoomlogo,
        lensShape: portfolio_store_zoom_obj.photo_gallery_lightbox_lensshape,
        lensSize: portfolio_store_zoom_obj.photo_gallery_lightbox_lenssize,
        wText: portfolio_store_zoom_obj.photo_gallery_lightbox_watermark_text,
        openCloseType: portfolio_store_zoom_obj.lightbox_open_close_effect,
        share: {
            facebookButton: portfolio_store_zoom_obj.photo_gallery_lightbox_facebookButton,
            twitterButton: portfolio_store_zoom_obj.photo_gallery_lightbox_twitterButton,
            googleplusButton: portfolio_store_zoom_obj.photo_gallery_lightbox_googleplusButton,
            pinterestButton: portfolio_store_zoom_obj.photo_gallery_lightbox_pinterestButton,
            linkedinButton: portfolio_store_zoom_obj.photo_gallery_lightbox_linkedinButton,
            tumblrButton: portfolio_store_zoom_obj.photo_gallery_lightbox_tumblrButton,
            redditButton: portfolio_store_zoom_obj.photo_gallery_lightbox_redditButton,
            bufferButton: portfolio_store_zoom_obj.photo_gallery_lightbox_bufferButton,
            diggButton: portfolio_store_zoom_obj.photo_gallery_lightbox_diggButton,
            vkButton: portfolio_store_zoom_obj.photo_gallery_lightbox_vkButton,
            yummlyButton: portfolio_store_zoom_obj.photo_gallery_lightbox_yummlyButton
        }
    };
    ...
    Lightbox.prototype.structure = function (index) {
        ...
        switch($object.settings.lightboxView){
            ...
            case 'view2':
            case 'view3':
                var $h = 2*Math.abs(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowv) + 92, $t;

                if(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowv < 0){
                    $t = Math.abs(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowv) + 47;
                } else {
                    $t = 47;
                }
                $inner.css({
            ...
            case 'view4':
                ...
                break;
            case 'view5':
                var $w = Math.abs(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowh) + 'px', $l;

                if(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowh < 0){
                    $l = Math.abs(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowh);
                ...
                break;
            case 'view6':
                var $w_ = Math.abs(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowh) + 'px', $l_;

                if(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowh < 0){
                    $l_ = Math.abs(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowh);
                    jQuery('.cont-inner').css({
                        width: 'calc(80% - ' + $w_ + ')',
                        left:  $l_ + 'px'
                    });
        ...
        if(portfolio_store_zoom_obj.photo_gallery_lightbox_rightclick_protection){
            setTimeout(function () {
    ...
    Lightbox.prototype.loadContent = function (index, rec, delay) {
        ...
        function _hexToRGBA() {
            var hex, opacity, bigint, r, g, b;
            hex = portfolio_store_zoom_obj.photo_gallery_lightbox_imagebordercolor;
            opacity = portfolio_store_zoom_obj.photo_gallery_lightbox_imageborderopacity / 100;
            bigint = parseInt(hex, 16);
            r = (bigint >> 16) & 255;
            g = (bigint >> 8) & 255;
            b = bigint & 255;
        ...
        if(portfolio_store_zoom_obj.photo_gallery_lightbox_imageborder){
            $('.rwd-image').css({
                border: portfolio_store_zoom_obj.photo_gallery_lightbox_imagebordersize + 'px solid ' + _hexToRGBA(),
                borderRadius: portfolio_store_zoom_obj.photo_gallery_lightbox_imageborderradius + 'px'
            });
        }

        if(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadow && (portfolio_store_zoom_obj.photo_gallery_lightbox_imageframe === 'frame_0' || portfolio_store_zoom_obj.photo_gallery_lightbox_imageborder)){
            var $shadowH = portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowh + 'px ',
                $shadowV = portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowv + 'px ',
                $blur = portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadow_blur + 'px ',
                $spread = portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadow_spread + 'px ',
                $color = '#' + portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadow_color;
    ...
    Lightbox.prototype.slide = function (index, fromSlide, fromThumb) {
        ...
        $('.rwd-container .rwd-thumb-item img').css({
            opacity: 1 - +portfolio_store_zoom_obj.photo_gallery_lightbox_thumbs_overlay_opacity / 100
        });
    ...
    Lightbox.prototype.goToNextSlide = function (fromSlide) {
        ...
        if(portfolio_store_zoom_obj.photo_gallery_lightbox_zoom){
        ...
        if(portfolio_store_zoom_obj.photo_gallery_lightbox_zoom){
            $('.rwd-object').each(function() {
                ...
                if ($(this).attr('style') && $(this).attr('style').indexOf('transform:') !== -1) {
                    ...
                    if (portfolio_store_zoom_obj.photo_gallery_lightbox_imageframe !== 'frame_8') {
                        $(this).css({
                            borderImage: 'url("' + webpace_resp_lightbox_plugins_url + portfolio_store_zoom_obj.photo_gallery_lightbox_imageframe + '.png") 90 95 95 90 stretch stretch'
                        });
                    } else {
                        $(this).css({
                            borderImage: 'url("' + webpace_resp_lightbox_plugins_url + portfolio_store_zoom_obj.photo_gallery_lightbox_imageframe + '.png") 90 123 85 129 stretch stretch'
                        });
                    }
                }
            });
    ...
    Modul.defaultsModul = {
        ...
        videoMaxWidth: portfolio_store_zoom_obj.photo_gallery_lightbox_videoMaxWidth,
        fullwidth: portfolio_store_zoom_obj.photo_gallery_lightbox_fullwidth_effect,
        zoom: portfolio_store_zoom_obj.photo_gallery_lightbox_zoom,
        zoomType: portfolio_store_zoom_obj.photo_gallery_lightbox_zoomtype,
        scale: +portfolio_store_zoom_obj.photo_gallery_lightbox_zoomsize / 10,
        thumbnail: true,
        thumbsWidth: 100,
        thumbsHeight: 100,
        thumbMargin: 5,
        ...
        thumbsOverlayColor: portfolio_store_zoom_obj.photo_gallery_lightbox_thumbs_overlay_color,
        thumbsOverlayOpacity: portfolio_store_zoom_obj.photo_gallery_lightbox_thumbs_overlay_opacity,
        fullscreen: portfolio_store_zoom_obj.photo_gallery_lightbox_fullscreen_effect
    };
        ...
        if (this.dataL.modulSettings.fullscreen) {
            if (!document.fullscreenEnabled && !document.webkitFullscreenEnabled && !document.mozFullScreenEnabled && !document.msFullscreenEnabled) {
                ...
                fullScreen = '<span class="rwd-fullscreen rwd-icon">' +
                    ...
                    '</g></g></svg>' +
                    '</span>';
                switch (portfolio_store_zoom_obj.photo_gallery_lightbox_lightboxView) {
                    case 'view1':
                    default:
    ...
    Modul.prototype.offFullWidth = function () {
        ...
        if((portfolio_store_zoom_obj.photo_gallery_lightbox_imageframe !== 'frame_0' && !portfolio_store_zoom_obj.photo_gallery_lightbox_imageborder) || portfolio_store_zoom_obj.photo_gallery_lightbox_imageborder){
    ...
    Modul.prototype.initZoom = function () {
        ...
        $('#rwd-zoom-out svg').on('click.rwd-container', function () {
            ...
            if(scale === 1){
                ...
                if(portfolio_store_zoom_obj.photo_gallery_lightbox_imageframe !== 'frame_0' && !portfolio_store_zoom_obj.photo_gallery_lightbox_imageborder){
                    if(portfolio_store_zoom_obj.photo_gallery_lightbox_imageframe !== 'frame_8'){
                        $('.rwd-image').css({
                            borderImage: 'url("' + webpace_resp_lightbox_plugins_url + portfolio_store_zoom_obj.photo_gallery_lightbox_imageframe + '.png") 90 95 95 90 stretch stretch'
                        });
        ...
        if (portfolio_store_zoom_obj.photo_gallery_lightbox_zoomlogo !== '0') {
                ...
                switch($object.dataL.settings.lightboxView){
                    case 'view1':
                        switch($object.dataL.modulSettings.thumbPosition){
                            case '0':
                                $cont_.css({
                                    height: 'calc(100% - ' + ($object.dataL.modulSettings.thumbsHeight + 2*Math.abs(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowv) + 92) + 'px)',
                                    top: Math.abs(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowv) + 47 + 'px'
                                });
                                $thumb_.css({
                                    bottom: '0',
                            ...
                            case '1':
                                $cont_.css({
                                    height: 'calc(100% - ' + ($object.dataL.modulSettings.thumbsHeight + Math.abs(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowv) + 92) + 'px)',
                    ...
                    case 'view2':
                        switch($object.dataL.modulSettings.thumbPosition) {
                            case '0':
                                $cont_.css({
                                    height: 'calc(100% - ' + ($object.dataL.modulSettings.thumbsHeight + Math.abs(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowv) + 92) + 'px)',
                                    top: Math.abs(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowv) + 45 + 'px'
                                });
                                $thumb_.css({
                                    bottom: '45px',
                                    backgroundColor: 'rgba(0,0,0,.9)'
                    ...
                    case 'view3':
                        switch($object.dataL.modulSettings.thumbPosition) {
                            ...
                            case '1':
                                $cont_.css({
                                    height: 'calc(100% - ' + ($object.dataL.modulSettings.thumbsHeight + Math.abs(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowv) + 93) + 'px)',
                    ...
                    case 'view4':
                        switch($object.dataL.modulSettings.thumbPosition) {
                            ...
                            case '1':
                                $cont_.css({
                                    height: 'calc(100% - ' + ($object.dataL.modulSettings.thumbsHeight + Math.abs(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowv) + 90) + 'px)',
                                    top: $object.dataL.modulSettings.thumbsHeight + 45 + 'px'
                                });
                                $thumb_.css({
                                    top: '45px',
                    ...
                    case 'view6':
                        switch($object.dataL.modulSettings.thumbPosition) {
                            case '0':
                                $cont_.css({
                                    height: 'calc(100% - ' + ($object.dataL.modulSettings.thumbsHeight + Math.abs(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowv)) + 'px)',
                                    top: Math.abs(portfolio_store_zoom_obj.photo_gallery_lightbox_imageshadowv) + 'px'
                                });
                                $thumb_.css({
                                    bottom: '0'
                                });
    ...
    Modul.prototype.buildThumbs = function() {
        var $object = this,
            thumbList = '',
            $thumb,
            html = '<span class="web_pace_icon-arrow_up"></span><span class="web_pace_icon-arrow_down"></span><div class="rwd-thumb-cont"><div class="rwd-thumb group"></div></div>';
    ...
    Modul.prototype.enableThumbDrag = function() {
        ...
        $('.web_pace_icon-arrow_up').on('click', function(){
        ...
        $('.web_pace_icon-arrow_down').on('click', function(){
            tempLeft = +$('.rwd-thumb').attr('data-left');
    ...
    Modul.prototype.destroy = function () {
        ...
        if (portfolio_store_zoom_obj.photo_gallery_lightbox_thumbs) {
    ...
    WaterMark.defaults = {
        imgSrc: portfolio_store_zoom_obj.photo_gallery_lightbox_watermark_img_src_new,
        text: portfolio_store_zoom_obj.photo_gallery_lightbox_watermark_text,
        textColor: '#' + portfolio_store_zoom_obj.photo_gallery_lightbox_watermark_textColor,
        textFontSize: +portfolio_store_zoom_obj.photo_gallery_lightbox_watermark_textFontSize,
        containerBackground: portfolio_store_zoom_obj.photo_gallery_lightbox_watermark_container_bg_color,
        containerWidth: +portfolio_store_zoom_obj.photo_gallery_lightbox_watermark_containerWidth,
        position: 'pos' + portfolio_store_zoom_obj.photo_gallery_lightbox_watermark_position_new,
        opacity: +portfolio_store_zoom_obj.photo_gallery_lightbox_watermark_containerOpacity / 100,
        margin: +portfolio_store_zoom_obj.photo_gallery_lightbox_watermark_margin,
    ...
    WaterMark.prototype.init = function () {
        ...
        WatermarkImage.css('display', 'none').attr('id', 'web_pace_watermark_img_sample');
        if (!jQuery('body').find('#web_pace_watermark_img_sample').length) {
        ...
        img.onload = function () {
            ...
            if (data.$wmObject) {
                ...
                if ($settings.text !== '') {
                    ...
                    $wmHeight = (jQuery('img#web_pace_watermark_img_sample').prop('naturalHeight') * $wmWidth) / jQuery('img#web_pace_watermark_img_sample').prop('naturalWidth');
                }
