    ...
    var n = r(0),
        ...
        s = function() {
            ...
            return o(t, [{
                ...
                value: function(t, e) {
                    var r = Object(n.h)(e);
                    r.transform += this.$node.css(r), this.props.lastPosition = t, this.props.filteredOut = !1
					r.top +=  t.top + "px", this.$node.css(r), this.props.lastPosition = t, this.props.filteredOut = !1
					r.left +=  t.left + "px", this.$node.css(r), this.props.lastPosition = t, this.props.filteredOut = !1
                ...
                value: function(t) {
                   ...
                   e.transform += this.$node.css(e), this.props.filteredOut = !0
					e.top +=  r.top + "px", this.$node.css(e), this.props.filteredOut = !0
					e.left +=  r.left + "px", this.$node.css(e), this.props.filteredOut = !0
